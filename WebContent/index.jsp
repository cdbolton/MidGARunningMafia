      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
	      ...
	      <div class="inner cover">
	            ...
	            <p class="lead">We are an elite racing team to promote top level health, fitness and competition in the middle Georgia area.</p>
	            <p class="lead">
	              <a href="about.jsp" class="btn btn-lg btn-default">Learn more</a>
	            </p>
	      </div>
